          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl backdrop-blur-sm bg-gray-700/50 border border-gray-600/30 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all duration-300"
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="p-3 rounded-xl backdrop-blur-sm bg-gray-700/50 border border-gray-600/30 text-white focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-all duration-300"
              >
                {eventTypes.map(type => (
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {featuredEvents.map((event) => {
                ...
                return (
                  <div key={event.id} className="group relative backdrop-blur-md bg-gray-800/70 rounded-2xl shadow-xl border border-gray-700/30 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden">
          ...
          {filteredEvents.length === 0 ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredEvents.map((event) => {
                ...
                return (
                  <div key={event.id} className="group backdrop-blur-md bg-gray-800/70 rounded-2xl shadow-xl border border-gray-700/30 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
                    ...
                    <div className="px-6 pb-6">
                      ...
                      {/* Action Button */}
                      <button className="w-full inline-flex items-center justify-center px-4 py-2 rounded-xl bg-gray-700 text-purple-400 font-semibold border border-purple-700 hover:bg-purple-900/20 transition-all duration-300">
                        Voir les détails
                        <ChevronRight className="w-4 h-4 ml-1" />
                      </button>
                    </div>
